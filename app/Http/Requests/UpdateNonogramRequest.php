...
class UpdateNonogramRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'data' => [ 'required_with:width', 'required_with:height', 'array', filter_var($width, FILTER_VALIDATE_INT) ? 'size:' . $height  : ''],
            'data.*' => [ 'required', 'array', filter_var($height, FILTER_VALIDATE_INT) ? 'size:' . $width : '' ],
