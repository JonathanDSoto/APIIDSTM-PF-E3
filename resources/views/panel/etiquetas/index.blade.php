              ...
              <div class=" space-y-5">
                <div class="card">
                  <header class=" card-header noborder">
                    ...
                    <button class="btn inline-flex justify-center btn-success">Añadir etiqueta</button>
                  </header>
                          ...
                          <table class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700" id="data-table">
                            ...
                            @for ($i = 1; $i < 50; $i++)
                                <tr>
                                    ...
                                    <td class="table-td ">Etiqueta {{ $i}}</td>
                                    <td class="table-td ">
                                        <div>
                                            <div class="relative">
        ...
        <div class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
            <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="input-area">
                        <label for="sizes_select" class="form-label">Color*</label>
                        <select required id="sizes_select" class="form-control">
                            <option value="size1" class="dark:bg-slate-700">Primary</option>
                            <option value="size2" class="dark:bg-slate-700">Secondary</option>
                            <option value="size3" class="dark:bg-slate-700">Info</option>
                            <option value="size4" class="dark:bg-slate-700">Success</option>
                            <option value="size5" class="dark:bg-slate-700">Warning</option>
                            <option value="size6" class="dark:bg-slate-700">Danger</option>
                            <option value="size7" class="dark:bg-slate-700">Dark</option>
                        </select>
                    </div>
                </div>
                <!-- Modal footer -->
