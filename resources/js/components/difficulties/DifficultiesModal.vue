...
watch(nombreDificultad, (nuevonombre, viejonombre) => {
    if (generarslug.value) {
        slugDificultad.value = slugify(nuevonombre ?? "", {
...
const cargarDificultad = (data) => {
    ...
    generarslug.value = (slugDificultad.value == slugify(nombreDificultad.value, {
        lower: true,      // convert to lower case, defaults to `false`
        strict: false,     // strip special characters except replacement, defaults to `false`
        locale: 'es',      // language code of the locale to use
        trim: true         // trim leading and trailing replacement chars, defaults to `true`
...
<template>
    <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto"
        id="difficultiesmodal" tabindex="-1" aria-labelledby="modal_editar" aria-hidden="true">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                    ...
                    <div class="p-6 space-y-4">
                        <div class="input-area">
                            ...
                            <input v-model="nombreDificultad" required id="name" type="text" class="form-control"
                                placeholder="Nombre">
                        ...
                        <div class="input-area">
                            ...
                            <input :disabled="generarslug" v-model="slugDificultad" required id="slug" type="text" class="form-control"
                                placeholder="Slug">
                    ...
                    <div
                        ...
                        <button @click="guardarDificultad"
